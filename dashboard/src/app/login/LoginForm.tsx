...
export default function LoginForm() {
  ...
  return (
    <form
      onSubmit={onSubmit}
      className="w-full max-w-sm overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-lg"
    >
      ...
      <div className="space-y-5 p-7">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-semibold leading-tight brand-text">UssdGatewayTz</h1>
        ...
        <div className="space-y-1.5">
          ...
          <input
            ...
            className="w-full rounded-lg border border-slate-300 dark:border-slate-700 bg-transparent px-3 py-2 text-sm outline-none transition focus:border-onfon-red focus:shadow-brand-focus"
          />
        </div>
        ...
        <button
          ...
          className="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-slate-900 dark:bg-slate-100 text-white dark:text-slate-900 px-3 py-2.5 text-sm font-medium outline-none transition hover:opacity-90 focus:shadow-brand-focus disabled:opacity-50"
        >
          {pending ? (
            <>
